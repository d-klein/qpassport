...
def read_dg1(connection,ap):
    ...
    if(data[0] == 0x61):
        ...
        dg1 = DG1()
        dg1.mrz_bin = tlv.read([0x5F,0x1F])
        mrz_txt = ''.join([chr(x) for x in dg1.mrz_bin])
        if(len(mrz_txt) == 90):
            # document is td1 (i.e. id-card): 3 lines of 30 char each
            dg1.mrz_line1 = mrz_txt[0:30]
            dg1.mrz_line2 = mrz_txt[30:60]
            dg1.mrz_line3 = mrz_txt[60:90]
            return dg1
        elif(len(mrz_txt) == 72):
            # a visa (two lines of 36)
            dg1.mrz_line1 = mrz_txt[0:36]
            dg1.mrz_line2 = mrz_txt[36:72]
            return dg1
        elif(len(mrz_txt) == 88):
            # passport (two lines of 44)
            dg1.mrz_line1 = mrz_txt[0:44]
            dg1.mrz_line2 = mrz_txt[44:88]
            return dg1
        else:
            l = len(mrz_txt)
